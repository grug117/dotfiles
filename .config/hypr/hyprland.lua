...
hl.config({
    general = {
        ...
        layout = "dwindle",
        col = {
            active_border = { colors = { "rgba(ff6633ee)", "rgba(ff6633ee)" }, angle = 45 },
...
hl.define_submap("resize", function()
    hl.bind(" + right", hl.dsp.window.resize({ x = 100, y = 0 }))
    hl.bind(" + left", hl.dsp.window.resize({ x = -100, y = 0 }))
    hl.bind(" + up", hl.dsp.window.resize({ x = 0, y = -100 }))
    hl.bind(" + down", hl.dsp.window.resize({ x = 0, y = 100 }))
